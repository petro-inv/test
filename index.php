...
class RequestHandlerClient
{
    ...
    public function run()
    {
        ...
        $headers['auth']['clientId'] = 6045;
        $headers['auth']['clientCompany'] = "qJDHp0b1zFJFSRHbSqI4";
        $headers['auth']['clientSecret'] = "NjA0NXFKREhwMGIxekZKRlNSSGJTcUk0Y2U2NmY2ZTZmOWRlZjUxMGFjNDBiYTJlNjVjMmFjZGEwMTQyZmZhZQ==";
